...
exports.ErrorToString = exports.RequestStatus = exports.ErrorWithStatusCode = void 0;
...
const defaultRequestHandler = (context, schemaVersion, parameters, accept, reject) => {
    ...
    const request = (uri.protocol === "https:" ? https_1.default : http_1.default)
        .request(options, (res) => {
        ...
        res.on("end", function () {
            ...
            if (serverSchemaVersion.length > 0) {
                if (serverSchemaVersion !== schemaVersion) {
                    console.warn("The client", `v${schemaVersion}`, "is out of date. The server expects version", `v${serverSchemaVersion}`);
                }
            }
            let jobj;
            try {
                ...
                if (res.statusCode == 200) {
                    reject(new ErrorWithStatusCode((0, exports.ErrorToString)(ex), res.statusCode));
                    return;
                }
            }
            if (res.statusCode !== 200) {
        ...
        .on("error", (err) => {
        reject(new ErrorWithStatusCode((0, exports.ErrorToString)(err), 0));
    });
    request.write(data);
    request.end();
};
//# sourceMappingURL=reactTypeScriptTemplate.js.map